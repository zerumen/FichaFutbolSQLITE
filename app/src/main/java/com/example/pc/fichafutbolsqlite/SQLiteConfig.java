...
public class SQLiteConfig extends SQLiteOpenHelper {
    ...
    String sqlCreate = "CREATE TABLE Jugadores (nombre TEXT , apellidos TEXT,dni TEXT, sexo TEXT,categoria TEXT)";

    public SQLiteConfig(Context contexto, String nombre,
